...
const repo_base_url = `https://github.com/${repo_config.owner}/${repo_config.name}`
...
const generate_app_menu = async () => {
    ...
    try {
        ...
        const { battery_state, daemon_state, maintain_percentage = 70, percentage } = await get_battery_status()
